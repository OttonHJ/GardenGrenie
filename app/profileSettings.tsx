        ...
        >
          <View style={styles.testCard}>
            <Text style={styles.categoryLabel}>
              ESTA ES LA SECCION DE EDICION DEL PERFIL DE USUARIO
            </Text>
          </View>

          <View style={styles.testCard}>
            <Text style={styles.categoryLabel}>
              ESTA ES LA SECCION DE INFORMACION DE LA APP
            </Text>
            <Text style={styles.categoryLabel}>
              CONTACTO, REDES SOCIALES, LOG OUT Y DEMAS
            </Text>
          </View>

          <View style={styles.testCard}>
            <Text style={styles.categoryLabel}>
              SOLUCIONAR TEMA DE MARGENES DE PANTALLA
            </Text>
          </View>
        </View>
      </ScrollView>
